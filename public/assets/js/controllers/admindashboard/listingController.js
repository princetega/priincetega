...
module.controller("listingController", [
  ...
  function (
    ...
    // };
      ...
      var formData = new FormData($("#addBlog")[0]);
      $.ajax({
        url: $scope.dirlocation + "adminapi/add_blog",
        type: "POST",
 ...
 $scope.agent_blogs = function () {
    ...
    $scope.get_blogs = function () {
      ...
      $('#listing_loader').show(500);
      $.ajax({
        url: $scope.dirlocation + "adminapi/get_all_blogs",
        type: "GET",
        async: true,
        cache: false,
        contentType: false,
        ...
        $scope.delete_blog = function (product_code) {
         // alert(product_code);
      ...
      $.ajax({
        url:
          $scope.dirlocation +
          "adminapi/delete_blog?product_code=" +
          product_code,
        type: "GET",
        async: true,
        cache: false,
     ...
     $scope.update_blogs = function (id) {
      $(".edit_" + id).show(500);
      $(".icon_edit_" + id).hide();

      var formData = new FormData($("#updateBlog")[0]);
      $.ajax({
        url: $scope.dirlocation + "adminapi/update_blog",
        type: "POST",
        data: formData,
        async: true,
        cache: false,
