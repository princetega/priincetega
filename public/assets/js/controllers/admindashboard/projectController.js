...
module.controller("projectController", [
  "$scope",
  "$sce",
  "$http",
  "infogathering",
  ...
  function (
    ...
    // };
      ...
      $.ajax({
        url: $scope.dirlocation + "adminapi/add_project",
        type: "POST",
    ...
    $scope.get_project = function () {
      ...
      $.ajax({
        url: $scope.dirlocation + "adminapi/get_all_project",
        type: "GET",
        async: true,
        cache: false,
        contentType: false,
        ...
        success: function (result) {
         ...
         $scope.update_project = function (id) {
          //alert("d");
      $(".edit_" + id).show(500);
      $(".icon_edit_" + id).hide();
      ...
      $.ajax({
        url: $scope.dirlocation + "adminapi/update_project",
        type: "POST",
        data: formData,
        async: true,
        cache: false,
    ...
    $scope.enable_or_disable_project = function (code, listing, index) {
     // alert('got here');
      ...
      $.ajax({
        url: $scope.dirlocation + "adminapi/disable_enable_project",
        data: formData,
        type: "POST",
        async: true,
        cache: false,
