...
module.controller("categoryController", [
  ...
  function (
    ...
    //alert(JSON.stringify($scope.admin_data));
    setTimeout(function () {
      $scope.$apply();
    }, 0);
    ...
    $scope.enable_disable_cat = function (code, sub) {
      $(".sub_loader_" + sub.id).show();
      $(".icon_" + sub.id).hide();
