...
module.controller("headerController", [
  ...
  function (
    ...
    else if((url.indexOf('web-design')>1)){
    $scope.menu_active = '3';
    }

    else if((url.indexOf('web-app')>1)){
    $scope.menu_active = '3';
    }

    else if((url.indexOf('strategy')>1)){
    $scope.menu_active = '3';
    }

    else if((url.indexOf('prototyping')>1)){
    $scope.menu_active = '3';
    }

    else if((url.indexOf('enterprise-solution')>1)){
    $scope.menu_active = '3';
    }
    ...
    $scope.menu_active = '2';
     ...
     else if((url.indexOf('start-a-project')>1)){
    $scope.menu_active = '4';
    }
    /*
    else if(url.indexOf('my_products')>1){
      $scope.menu_active = '3';
    }
    ...
    */
    ...
    $scope.hide_side_container = function(){
      //alert("kl");
