    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            <li class="nav-item" ng-class="{'active': menu_active == '1'}" ng-click="menu_active='1'; hide_sidebar()">
                <a class="nav-link" href="{{dirlocation}}admindashboard/home">
            ...
            <li class="nav-item" ng-class="{'active': menu_active == '4'}" ng-click="menu_active='4';  hide_sidebar()">
                <a class="nav-link" href="{{dirlocation}}admindashboard/training">
                    <span class="menu-title">Trainng</span>
                    <i class="mdi mdi-account-multiple menu-icon"></i>
                </a>
            </li>
              <li class="nav-item" ng-class="{'active': menu_active == '4'}" ng-click="menu_active='4';  hide_sidebar()">
                <a class="nav-link" href="{{dirlocation}}admindashboard/project">
